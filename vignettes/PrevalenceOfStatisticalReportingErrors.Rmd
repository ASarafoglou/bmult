...
Given the informed hypothesis, our data are highly unlikely; in fact, we collected
extreme evidence against our informed hypothesis. The results suggest that the data 
are `r signif(1/ineq_results$bf$bf[['BFre']], 3)` more likely under
the hypothesis that all parameters are free to vary than under our informed hypothesis.
...
Given the null hypothesis, again, our data are highly unlikely; in fact, we collected
extreme evidence against the null hypothesis. The results suggest that the data 
are `r signif(1/eq_bayesfactors[['BFe0']], 3)` more likely under
...
under the null hypothesis. But since the data are more likely under the 
encompassing hypotheses than under the infomed hypothesis (i.e., BFer=`r signif(1/BFre, 3)`) 
or the null hypothesis (i.e., BFe0=`r signif(BFe0, 3)`), it would be more
sensible to assume that both models misspecify the data.