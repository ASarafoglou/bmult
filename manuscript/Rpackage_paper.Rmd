...
\Alex{I do not want summary to print stuff when I extract information from it. fix this bug.}
...
### Method
As before, we can compute $\text{BF}_{0r}$ through the transitivity of the Bayes factor, that is, $\text{BF}_{r0} = \text{BF}_{re} \times \text{BF}_{e0}$. The Bayes factor $\text{BF}_{e0}$ can be computed by using the `binom_bf_equality` function. 
...
results_He_H0   <- binom_bf_equality(x = x, n = n, a = a, b = b)
...
# Execute the analysis
results_Hr_He <- binom_bf_informed(x = x, n = n, Hr = Hr, a = a, b = b,
