...
\Frederik{I like the final sentence, but the Hoijtink quote seems a little to restrictive to me. These expectations could be added to the null or alternative hypothesis depending on how the test is constructed. Do you think we could amend it slightly and present it as paraphrasis, e.g.,

Generally, by specifying informed hypotheses researchers and practitioners can add theoretical expectations to the compared hypotheses [@hoijtink2008bayesian, p. 2] and thus compare hypotheses that relate more closely to their theories [@haaf2019capturngPreprint; @rijkeboer2008psychologists].

Alternatively, we could add Hoijtink to the trailing list of citations.}
...
\Frederik{Maybe a little more assertive: it becomes increasingly unreliable and inefficient}
