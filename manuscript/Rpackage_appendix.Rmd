...
To perform the transformations, we need to determine the lower bound $l_k$ and the upper bound $u_k$ of each $\theta_k$. Assuming $\theta_{k-1} < \theta_{k}$ for $k \in \{1 \cdots, K\}$ the lower bound for any element in $\boldsymbol{\theta}$ is defined as
